    ...
    <footer class="site-footer">
      <div class="container">
        <div class="row">
          <div class="col-lg-4">
            <div class="mb-5">
              <h3 class="footer-heading mb-4">About AuctionXpert</h3>
              <p>
              Redefining real estate with innovation. Our platform offers seamless auctions, in-depth suburb research, proven results, and top-notch security. Trust us for a dynamic, transparent, and secure property experience.              </p>
            </div>
          </div>
