...
if (isset($_POST['submit'])){
    ...
    // Modify the query to use starting_price instead of price
    $search = $conn->prepare("SELECT * FROM props WHERE (home_type LIKE :types and type LIKE :offers and location LIKE :cities) AND end_datetime > NOW()");
    $search->execute([
        'types' => '%' . $types . '%',
        'offers' => '%' . $offers . '%',
        'cities' => '%' . $cities . '%'
                ...
                <?php foreach($listings as $listing): ?>
                    <div class="col-md-6 col-lg-4 mb-4">
                        ...
                        <div class="p-4 property-body">
                            ...
                            <strong class="property-price text-primary mb-3 d-block text-success">RM<?php echo $listing->price;?></strong>
