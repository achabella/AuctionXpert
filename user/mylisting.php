...
props.price AS price, props.beds AS beds, props.baths AS baths, props.sqft AS sqft, props.type AS type FROM props JOIN owners ON props.id = owners.prop_id WHERE owners.user_id = '$_SESSION[user_id]'");
...
<div class="container">
        ...
        <?php foreach($props as $prop):?>
          ...
          <?php else : ?>
            <div class="bg-success text-white">You did not add any properties for auction yet</div>
            <?php endif ; ?>
