...
if(isset($_GET['type'])){
  $type = $_GET['type'];
  $rent = $conn->prepare("SELECT * FROM props WHERE type = :type AND end_datetime > :currentDateTime");
  $rent->bindParam(':type', $type, PDO::PARAM_STR);
  $rent->bindParam(':currentDateTime', $currentDateTime, PDO::PARAM_STR);
  $rent->execute();
            ...
            <div class="view-options bg-white py-3 px-3 d-md-flex align-items-center">
              ...
              <div class="ml-auto d-flex align-items-center">
                <div>
                  ...
                  <a href="sale.php?type=sale" class="view-list px-3 active ">Sale</a>
