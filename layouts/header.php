...
<head>
    ...
    <title>AuctionXpert &mdash;Admin Panel</title>
...
<div id="wrapper">
    <nav class="navbar header-top fixed-top navbar-expand-lg  navbar-dark bg-dark">
      <div class="container">
      <a class="navbar-brand" href="#">AuctionXpert.</a>
      ...
      <div class="collapse navbar-collapse" id="navbarText">
        ...
        <ul class="navbar-nav side-nav" >
          ...
          <li class="nav-item">
            <a class="nav-link" href="<?php echo ADMINURL ; ?>/bids-admins/show-bids.php" style="margin-left: 20px;">Bids</a>
          </li>
          <li class="nav-item">
